            ...
            cls = { String board ->
                stage('Linux Tests') {
                    ...
                    try {
                        ...
                        // Rename logs
                        run_i("if [ -f dmesg.log ]; mv dmesg.log dmesg_" + board + ".log; fi")
                        run_i("if [ -f dmesg_err.log ]; mv dmesg_err.log dmesg_" + board + "_err.log; fi")
                        run_i("if [ -f dmesg_warn.log ]; mv dmesg_warn.log dmesg_" + board + "_warn.log; fi")
